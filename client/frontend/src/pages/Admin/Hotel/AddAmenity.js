        ...
        <div className="w-full mb-12 xl:mb-0 px-4 padding-top80">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-6">
              ...
              <input type="text" id="amenity" onChange={(e) => setAmenity(e.target.value)} className=" border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " required="" />
            </div>
            <div className='mb-6'>
            ...
            <div className='mb-6'>
              <label className="block mb-2 text-sm font-medium text-gray-900 " htmlFor="file_input">Upload Amenity Logo</label>
