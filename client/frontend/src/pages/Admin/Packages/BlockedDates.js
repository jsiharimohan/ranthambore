                            ...
                            <tbody>
                                {list && list.map((item, index) => (
                                    ...
                                    <tr key={index} >
                                        ...
                                        <td  class="border border-slate-300 text-center"><a class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center mr-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800" href={`/admin/edit-block-date/${item._id}`}><i class="fas fa-pencil"></i></a>
